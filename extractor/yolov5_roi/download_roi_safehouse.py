...
"""
if running anywhere other than DevAI account Sagemaker,

Run "export AWS_PROFILE=Developers_custom1_tallydev-AI-381491826341" in the termail to set appropriate profile
...
local_roi_json_folder = os.path.join(dataset_folder, "roi_jsons")
